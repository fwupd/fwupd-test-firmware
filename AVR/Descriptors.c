...
const USB_Descriptor_Device_t PROGMEM DeviceDescriptor =
{
	...
	.VendorID               = USB_VID,
	.ProductID              = USB_PID,
	.ReleaseNumber          = VERSION_BCD(VERSION_MAJOR,VERSION_MINOR,VERSION_MICRO),
	...
	.DFU_Functional =
		{
			...
			.Attributes             = (ATTR_CAN_UPLOAD | ATTR_CAN_DOWNLOAD | ATTR_WILL_DETATCH | ATTR_MANEFESTATION_TOLLERANT),
 ...
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ManufacturerString = USB_STRING_DESCRIPTOR(USB_VENDOR);
